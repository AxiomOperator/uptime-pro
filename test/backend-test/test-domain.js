...
describe("Domain Expiry", () => {
    ...
    test("sendNotifications() handles domain with null expiry without sending NaN", async () => {
        ...
        // Mock findByDomainNameOrCreate to return a record with null expiry
        const mockDomain = {
    ...
    test("sendNotifications() handles domain with undefined expiry without sending NaN", async () => {
        try {
            // Mock findByDomainNameOrCreate to return a record with undefined expiry (newly created record scenario)
            const mockDomain = {
